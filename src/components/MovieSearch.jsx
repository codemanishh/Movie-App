      ...
      {selectedMovie && (
        <div className='div2boxes'>
          ...
          <div className="movie-info">
            <h3 className="movie-title"><b>{selectedMovie.Title}</b></h3>
            <ul className="movie-misc-info">
              <li className="year"><b> Year:</b> {selectedMovie.Year}</li>
              <li className="rated"><b> Ratings: </b>{selectedMovie.Rated}</li>
              <li className="released"><b> Released:</b> {selectedMovie.Released}</li>
            </ul>
            <p className="genre">
